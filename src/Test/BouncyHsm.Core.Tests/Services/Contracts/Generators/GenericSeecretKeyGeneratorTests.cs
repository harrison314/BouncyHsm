...
[TestClass]
public class GenericSeecretKeyGeneratorTests
{
    [DataTestMethod]
    ...
    {
        GenericSeecretKeyGenerator generator = new GenericSeecretKeyGenerator(new NullLogger<GenericSeecretKeyGenerator>());
