...
internal class CkSP800_108FeedbackKdfParams : ICkSP800_108FeedbackKdfParams
{
    ...
    protected virtual void Dispose(bool disposing)
    {
        if (!this.disposedValue)
        {
            ...
            MemoryUtils.MemFreeReset(ref this.lowLevelStruct.pIV);
