...
[TestClass]
public class T39_DecapsulateKeyEcdsa
{
    ...
    public void DecapsulateKey_EcDh1Derive_Success(int sharedDataLength, CKD mgfFunction, int sectetLength)
    {
    ...
    [DataRow(16, CKD_V3_0.CKD_SHA3_384_KDF, 32)]
    [DataRow(16, CKD_V3_0.CKD_SHA3_512_KDF, 32)]
    public void DecapsulateKey_EcDh1CofactorDerive_Success(int sharedDataLength, CKD mgfFunction, int sectetLength)
    {
        Pkcs11InteropFactories factories = new Pkcs11InteropFactories();
        using IPkcs11Library library = factories.Pkcs11LibraryFactory.LoadPkcs11Library(factories,
            AssemblyTestConstants.P11LibPath,
