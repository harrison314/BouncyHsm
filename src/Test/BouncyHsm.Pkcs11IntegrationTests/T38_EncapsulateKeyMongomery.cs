...
[TestClass]
public class T38_EncapsulateKeyMongomery
{
    ...
    public void EncapsulateKey_EcDh1Derive_Success(string curveName, int sharedDataLength, CKD mgfFunction, int sectetLength)
    {
