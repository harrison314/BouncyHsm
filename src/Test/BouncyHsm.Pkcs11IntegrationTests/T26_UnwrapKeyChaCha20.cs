...
[TestClass]
public class T26_UnwrapKeyChaCha20
{
    ...
    public void Wrap_ChaCha20_Success()
    {
        ...
        using IMechanismParams chachaParams2 = Pkcs11V3_0Factory.Instance.MechanismParamsFactory.CreateCkChaCha20Params((uint)0, nonce);
        using IMechanism mechanism2 = session.Factories.MechanismFactory.Create(CKM_V3_0.CKM_CHACHA20, chachaParams2);
    
        IObjectHandle unwrapedKey = session.UnwrapKey(mechanism2, chaChaKey, wrappedKey, this.GetAesKeytamplate(session));
    }
