...
public class T38_EncapsulateKeyMlKem
{
    ...
    [TestMethod]
    public void EncapsulateKey_WithPermitedAlgorithm_Failed()
    {
        Pkcs11InteropFactories factories = new Pkcs11InteropFactories();
        using IPkcs11Library library = factories.Pkcs11LibraryFactory.LoadPkcs11Library(factories,
            AssemblyTestConstants.P11LibPath,
        ...
        Pkcs11Exception ex = Assert.ThrowsExactly<Pkcs11Exception>(() => session.EncapsulateKey(library,
            mechanism,
            publicKey,
            template,
            out byte[] cipherText,
    ...
    [TestMethod]
    public void EncapsulateKey_ReadonlySession_Success()
    {
        Pkcs11InteropFactories factories = new Pkcs11InteropFactories();
        using IPkcs11Library library = factories.Pkcs11LibraryFactory.LoadPkcs11Library(factories,
            AssemblyTestConstants.P11LibPath,
    ...
    [TestMethod]
    public void EncapsulateKey_NotLoggedIn_Success()
    {
        Pkcs11InteropFactories factories = new Pkcs11InteropFactories();
        using IPkcs11Library library = factories.Pkcs11LibraryFactory.LoadPkcs11Library(factories,
            AssemblyTestConstants.P11LibPath,
