...
[TestClass]
public class T22_GenerateKeyChaCha20
{
    ...
    [TestMethod]
    public void Ganerate_ChaCha20_Success()
    {
        ...
        using IMechanism mechanism = factories.MechanismFactory.Create(CKM_V3_0.CKM_CHACHA20_KEY_GEN);
