...
internal class GenerateCamelliaKeyCommand : AsyncCommand<GenerateCamelliaKeyCommand.Settings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings, CancellationToken cancellationToken)
    {
        ...
        await AnsiConsole.Status()
           ...
           {
               await client.GenerateCamelliaKeyAsync(settings.SlotId, new GenerateCamelliaKeyRequestDto()
               {
        ...
        AnsiConsole.MarkupLine("Camellia key has created.");
        return 0;
    }
}