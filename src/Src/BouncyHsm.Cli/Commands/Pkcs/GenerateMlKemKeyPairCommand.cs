...
internal class GenerateMlKemKeyPairCommand : AsyncCommand<GenerateMlKemKeyPairCommand.Settings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings, CancellationToken cancellationToken)
    {
        ...
        await AnsiConsole.Status()
           ...
           {
               await client.GenerateMlKemKeyPairAsync(settings.SlotId, new GenerateMlKemKeyPairRequestDto()
               {
                   MlKemParameter = settings.MlKemParameter,
