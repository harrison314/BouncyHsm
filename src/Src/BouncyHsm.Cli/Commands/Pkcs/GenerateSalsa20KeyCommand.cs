...
internal class GenerateSalsa20KeyCommand : AsyncCommand<GenerateSalsa20KeyCommand.Settings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings)
    {
        ...
        await AnsiConsole.Status()
           ...
           {
               await client.GenerateSalsa20KeyAsync(settings.SlotId, new GenerateSalsa20KeyRequestDto()
               {
