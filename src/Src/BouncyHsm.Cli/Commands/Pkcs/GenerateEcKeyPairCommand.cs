...
internal class GenerateEcKeyPairCommand : AsyncCommand<GenerateEcKeyPairCommand.Settings>
{
    internal sealed class Settings : BaseSettings
    {
        ...
        [Description("Name or OID of elepitic curve name.")]
    ...
    protected override async Task<int> ExecuteAsync(CommandContext context, Settings settings, CancellationToken cancellationToken)
    {
        ...
        await AnsiConsole.Status()
           ...
           {
               await client.GenerateEcKeyPairAsync(settings.SlotId, new GenerateEcKeyPairRequestDto()
               {
