...
internal class GenerateEdwardsKeyPairCommand : AsyncCommand<GenerateEdwardsKeyPairCommand.Settings>
{
    internal sealed class Settings : BaseSettings
    {
        ...
        [Description("Name or OID of edwards curve name.")]
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings, CancellationToken cancellationToken)
    {
        ...
        await AnsiConsole.Status()
           ...
           {
               await client.GenerateEdwardsKeyPairAsync(settings.SlotId, new GenerateEdwardsKeyPairRequestDto()
               {
