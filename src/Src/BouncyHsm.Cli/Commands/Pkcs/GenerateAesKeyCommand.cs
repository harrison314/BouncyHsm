...
internal class GenerateAesKeyCommand : AsyncCommand<GenerateAesKeyCommand.Settings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings)
    {
        ...
        await AnsiConsole.Status()
           ...
           {
               await client.GenerateAesKeyAsync(settings.SlotId, new GenerateAesKeyRequestDto()
               {
