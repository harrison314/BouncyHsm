...
public sealed class Salsa20KeyObject : SecretKeyObject
{
    ...
    public Salsa20KeyObject()
        : base(CKK.CKK_SALSA20, CKM.CKM_SALSA20_KEY_GEN)
    {
        this.CkaValue = Array.Empty<byte>();
        this.CkaValueLen = 0;
    }

    public Salsa20KeyObject(StorageObjectMemento memento)
        : base(memento)
    {
    ...
    public override void Validate()
    {
        ...
        {
            throw new RpcPkcs11Exception(CKR.CKR_ATTRIBUTE_VALUE_INVALID,
              $"Attribute {CKA.CKA_VALUE} has no valid lenght for SALSA20 (32B) key.");
        }
    }

    public override string ToString()
    {
        return $"{this.GetType().Name} (SALSA20): Id={this.Id}";
    }
