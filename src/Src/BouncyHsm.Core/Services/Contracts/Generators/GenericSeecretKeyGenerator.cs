...
internal class GenericSeecretKeyGenerator : IKeyGenerator
{
    private readonly ILogger<GenericSeecretKeyGenerator> logger;
    private IReadOnlyDictionary<CKA, IAttributeValue>? template;

    public GenericSeecretKeyGenerator(ILogger<GenericSeecretKeyGenerator> logger)
    {
        this.logger = logger;
    }
    ...
    {
        return "GenericSeecretKeyGenerator";
    }
