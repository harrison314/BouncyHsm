...
internal static class MechanismUtils
{
    ...
    static MechanismUtils()
    {
        originalMechanism = new Dictionary<CKM, MechanismInfo>()
        {
            ...
            {CKM.CKM_MD5_HMAC, new MechanismInfo(20, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.NONE, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_RIPEMD128_HMAC, new MechanismInfo(16, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.NONE, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_RIPEMD160_HMAC, new MechanismInfo(20, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.NONE, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_SHA_1_HMAC, new MechanismInfo(20, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.NONE, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_SHA224_HMAC, new MechanismInfo(28, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.NONE, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_SHA256_HMAC, new MechanismInfo(32, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.NONE, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_SHA384_HMAC, new MechanismInfo(48, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.NONE, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_SHA512_HMAC, new MechanismInfo(64, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.NONE, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_SHA512_224_HMAC, new MechanismInfo(28, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.NONE, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_SHA512_256_HMAC, new MechanismInfo(32, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.NONE, Pkcs11SpecVersion.V2_40) },

            //General hmacing
            {CKM.CKM_MD2_HMAC_GENERAL, new MechanismInfo(16, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_MD5_HMAC_GENERAL, new MechanismInfo(20, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_RIPEMD128_HMAC_GENERAL, new MechanismInfo(16, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_RIPEMD160_HMAC_GENERAL, new MechanismInfo(20, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_SHA_1_HMAC_GENERAL, new MechanismInfo(20, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_SHA224_HMAC_GENERAL, new MechanismInfo(28, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_SHA256_HMAC_GENERAL, new MechanismInfo(32, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_SHA384_HMAC_GENERAL, new MechanismInfo(48, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_SHA512_HMAC_GENERAL, new MechanismInfo(64, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_SHA512_224_HMAC_GENERAL, new MechanismInfo(28, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, Pkcs11SpecVersion.V2_40) },
            {CKM.CKM_SHA512_256_HMAC_GENERAL, new MechanismInfo(32, SecretMaxKeySize, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, MechanismCkf.CKF_SIGN | MechanismCkf.CKF_VERIFY, Pkcs11SpecVersion.V2_40) },
