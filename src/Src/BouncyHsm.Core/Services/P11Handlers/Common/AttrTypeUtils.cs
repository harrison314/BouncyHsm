...
internal static class AttrTypeUtils
{
    public static AttrTypeTag GetTypeTag(CKA attributeType)
    {
        return attributeType switch
        {
            ...
            CKA.CKA_TRUST_CODE_SIGNING => AttrTypeTag.CkUint,
            CKA.CKA_TRUST_EMAIL_PROTECTION => AttrTypeTag.CkUint,
            CKA.CKA_TRUST_IPSEC_IKE => AttrTypeTag.CkUint,
            ...
            CKA.CKA_PUBLIC_CRC64_VALUE => AttrTypeTag.ByteArray,
            CKA.CKA_ENCAPSULATE => AttrTypeTag.CkBool,
            CKA.CKA_DECAPSULATE => AttrTypeTag.CkBool,
