...
public static partial class RpcDefinitionUtils
{
   ...
   public static IReadOnlyDictionary<Type, Type> GetRegistrations()
   {
      ...
      return new Dictionary<Type, Type>()
      {
         ...
         { typeof(IRpcRequestHandler<InitTokenRequest, InitTokenEnvelope>), typeof(InitTokenHandler)},
         { typeof(IRpcRequestHandler<InitPinRequest, InitPinEnvelope>), typeof(InitPINHandler)},
